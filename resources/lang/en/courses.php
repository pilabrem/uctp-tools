...
return [
    ...
    'index_route_description' => 'Retrieve existing courses.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the course property name where the value is the assigned value to the retrieved course.',
    ...
    'show_route_description' => 'Retrieve existsing course.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the course to retrieve',
    'destroy_route_description' => 'Delete existsing course.',
    ...
    'the_id_of_model_to_delete' => 'The id of the course to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete courses.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the course.',
    ...
    'the_requested_model_does_not_exists' => 'The requested course does not exists.',
    ...
    'create' => 'Ajouter Course',
    'delete' => 'Supprimer Course',
    'edit' => 'Modifier Course',
    'show' => 'Afficher Course',
    'show_all' => 'Afficher tous les Course',
    'add' => 'Ajouter',
    'update' => 'Mettre à jour',
    'confirm_delete' => 'Supprimer Course?',
    'none_available' => 'Aucun Course Trouvé!',
    'model_plural' => 'Courses',
    'model_was_added' => 'Le Course a été ajouté avec succès',
    'model_was_retrieved' => 'Course was successfully retrieved.',
    'models_were_retrieved' => 'Courses were successfully retrieved.',
    'model_was_updated' => 'Le Course a été modifié avec succès!',
    'model_was_deleted' => 'Le Course a été supprimé avec succès!',
