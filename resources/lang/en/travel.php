...
return [
    ...
    'travel_to_id' => 'Travel to',
    'travel_to_id__placeholder' => 'Selectionner travel to',
    'value' => 'Value',
    'value__placeholder' => 'Entrer value ici...',
    'access_token_with_bearer' => 'The access token prefixed with the "Bearer " key word.',
    'index_route_description' => 'Retrieve existing travel.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the travel property name where the value is the assigned value to the retrieved travel.',
    ...
    'show_route_description' => 'Retrieve existsing travel.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the travel to retrieve',
    'destroy_route_description' => 'Delete existsing travel.',
    ...
    'the_id_of_model_to_delete' => 'The id of the travel to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete travel.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the travel.',
    ...
    'the_requested_model_does_not_exists' => 'The requested travel does not exists.',
    ...
    'create' => 'Ajouter Travel',
    'delete' => 'Supprimer Travel',
    'edit' => 'Modifier Travel',
    'show' => 'Afficher Travel',
    'show_all' => 'Afficher tous les Travel',
    'add' => 'Ajouter',
    'update' => 'Mettre à jour',
    'confirm_delete' => 'Supprimer Travel?',
    'none_available' => 'Aucun Travel Trouvé!',
    'model_plural' => 'Travel',
    'model_was_added' => 'Le Travel a été ajouté avec succès',
    'model_was_retrieved' => 'Travel was successfully retrieved.',
    'models_were_retrieved' => 'Travel were successfully retrieved.',
    'model_was_updated' => 'Le Travel a été modifié avec succès!',
    'model_was_deleted' => 'Le Travel a été supprimé avec succès!',
