...
return [
    ...
    'index_route_description' => 'Retrieve existing configs.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the config property name where the value is the assigned value to the retrieved config.',
    ...
    'show_route_description' => 'Retrieve existsing config.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the config to retrieve',
    'destroy_route_description' => 'Delete existsing config.',
    ...
    'the_id_of_model_to_delete' => 'The id of the config to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete configs.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the config.',
    ...
    'the_requested_model_does_not_exists' => 'The requested config does not exists.',
    ...
    'create' => 'Ajouter Config',
    'delete' => 'Supprimer Config',
    'edit' => 'Modifier Config',
    'show' => 'Afficher Config',
    'show_all' => 'Afficher tous les Config',
    'add' => 'Ajouter',
    'update' => 'Mettre à jour',
    'confirm_delete' => 'Supprimer Config?',
    'none_available' => 'Aucun Config Trouvé!',
    'model_plural' => 'Configs',
    'model_was_added' => 'Le Config a été ajouté avec succès',
    'model_was_retrieved' => 'Config was successfully retrieved.',
    'models_were_retrieved' => 'Configs were successfully retrieved.',
    'model_was_updated' => 'Le Config a été modifié avec succès!',
    'model_was_deleted' => 'Le Config a été supprimé avec succès!',
