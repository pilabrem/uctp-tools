...
return [
    ...
    'id_room' => 'Id Room',
    'id_room__placeholder' => 'Entrer id room ici...',
    'capacity' => 'Capacity',
    'capacity__placeholder' => 'Entrer capacity ici...',
    'problem_id' => 'Problem',
    'problem_id__placeholder' => 'Selectionner problem',
    'access_token_with_bearer' => 'The access token prefixed with the "Bearer " key word.',
    'index_route_description' => 'Retrieve existing rooms.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the room property name where the value is the assigned value to the retrieved room.',
    ...
    'show_route_description' => 'Retrieve existsing room.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the room to retrieve',
    'destroy_route_description' => 'Delete existsing room.',
    ...
    'the_id_of_model_to_delete' => 'The id of the room to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete rooms.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the room.',
    ...
    'the_requested_model_does_not_exists' => 'The requested room does not exists.',
    ...
    'create' => 'Ajouter Room',
    'delete' => 'Supprimer Room',
    'edit' => 'Modifier Room',
    'show' => 'Afficher Room',
    'show_all' => 'Afficher tous les Room',
    'add' => 'Ajouter',
    'update' => 'Mettre à jour',
    'confirm_delete' => 'Supprimer Room?',
    'none_available' => 'Aucun Room Trouvé!',
    'model_plural' => 'Rooms',
    'model_was_added' => 'Le Room a été ajouté avec succès',
    'model_was_retrieved' => 'Room was successfully retrieved.',
    'models_were_retrieved' => 'Rooms were successfully retrieved.',
    'model_was_updated' => 'Le Room a été modifié avec succès!',
    'model_was_deleted' => 'Le Room a été supprimé avec succès!',
