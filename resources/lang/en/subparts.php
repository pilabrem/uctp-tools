...
return [
    ...
    'config_id' => 'Config',
    'config_id__placeholder' => 'Selectionner config',
    'access_token_with_bearer' => 'The access token prefixed with the "Bearer " key word.',
    'index_route_description' => 'Retrieve existing subparts.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the subpart property name where the value is the assigned value to the retrieved subpart.',
    ...
    'show_route_description' => 'Retrieve existsing subpart.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the subpart to retrieve',
    'destroy_route_description' => 'Delete existsing subpart.',
    ...
    'the_id_of_model_to_delete' => 'The id of the subpart to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete subparts.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the subpart.',
    ...
    'the_requested_model_does_not_exists' => 'The requested subpart does not exists.',
    ...
    'create' => 'Ajouter Subpart',
    'delete' => 'Supprimer Subpart',
    'edit' => 'Modifier Subpart',
    'show' => 'Afficher Subpart',
    'show_all' => 'Afficher tous les Subpart',
    'add' => 'Ajouter',
    'update' => 'Mettre à jour',
    'confirm_delete' => 'Supprimer Subpart?',
    'none_available' => 'Aucun Subpart Trouvé!',
    'model_plural' => 'Subparts',
    'model_was_added' => 'Le Subpart a été ajouté avec succès',
    'model_was_retrieved' => 'Subpart was successfully retrieved.',
    'models_were_retrieved' => 'Subparts were successfully retrieved.',
    'model_was_updated' => 'Le Subpart a été modifié avec succès!',
    'model_was_deleted' => 'Le Subpart a été supprimé avec succès!',
