...
<body class="hold-transition {{env('THEME', 'skin-red')}} sidebar-mini fixed">
    <div class="modal fade bs-example-modal-lg" id="document-viewer" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <iframe src=""
                    id="doc-iframe" width="100%" height="500"></iframe>
            </div>
        </div>
    </div>
